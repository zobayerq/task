  ...
  return (
    <div className='flex justify-center items-center '>
      ...
      {showName?.name ? (
        ...
        <label className=" mx-auto flex max-w-[700px] flex-col items-center justify-center space-y-3 rounded-lg border-2 border-dashed border-gray-400 p-6 bg-white" htmlFor="file5">
          ...
          <div className="space-y-1.5 text-center">
            <h5 className="whitespace-nowrap text-lg font-medium tracking-tight ">Upload your Image</h5>
      ...
      <input ref={fileInputRef} onChange={(e) => {
        ...
        }} className="hidden" id="file5" type="file"  name='image' accept='image/*'/>
    </div>
        ...
        <p className='px-6 text-sm text-center text-gray-400'>
          ...
          <Link
            to='/login'
            className='hover:underline hover:text-custom-bg text-gray-600'
          >
            Login
          </Link>
          .
